...
export function JobsSidebar({ activeSection = 'jobs', onSectionChange }: JobsSidebarProps) {
 ...
 className="h-6 w-6"
 >
 <circle cx="12" cy="12" r="9" className="fill-[#f7d046]" />
 ...
 <div className="absolute bottom-12 left-1/2 z-20 w-44 -translate-x-1/2 rounded-2xl border border-[#ece8df] bg-white p-2 shadow-md">
