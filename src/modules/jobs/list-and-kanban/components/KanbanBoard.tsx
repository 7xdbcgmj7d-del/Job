        ...
        return (
          ...
          >
            <div className="mb-4 flex items-center justify-between">
              <h3 className="text-sm font-semibold text-[#1a1a1a] dark:text-[#f5f5f5]">{status}</h3>
              <span className="rounded-full bg-white px-2.5 py-1 text-xs text-[#666666] dark:bg-[#2a2a2a] dark:text-[#b8b8b8]">
                {statusJobs.length}
              </span>
            </div>
            ...
            <div className="space-y-3">
              {statusJobs.length > 0 ? (
                ...
                <div className="rounded-2xl border border-dashed border-[#ddd6cc] bg-[#fbfaf8] p-4 text-center text-xs text-[#666666] dark:border-[#4a4a4a] dark:bg-[#2a2a2a] dark:text-[#b8b8b8]">
                  暂无岗位
                </div>
              )}
            </div>
