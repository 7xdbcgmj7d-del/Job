...
export const initialJobsData: JobItem[] = [
  { id: 1, company: 'Google', position: 'Senior Product Manager', salary: '150-200K', status: '面试中', bgColor: '#fadcd9', hasResume: true, appliedAt: daysAgo(2) },
  ...
  { id: 4, company: 'Apple', position: 'Product Manager', salary: '140-190K', status: '面试中', bgColor: '#fbe0c3', hasResume: false, appliedAt: daysAgo(8) },
  ...
  { id: 7, company: 'Tesla', position: 'Product Manager', salary: '130-170K', status: '面试中', bgColor: '#dcd6f7', hasResume: false, appliedAt: daysAgo(1) },
