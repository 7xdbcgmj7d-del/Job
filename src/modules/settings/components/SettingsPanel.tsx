...
<body>
 ...
 return (
 <div className="mx-auto max-w-3xl space-y-6 text-[#1a1a1a]">
 <div>
 <h1 className="text-3xl font-bold text-[#1a1a1a]">设置与数据管理</h1>
 <p className="mt-1 text-sm text-[#666666]">API 配置、AI 提供商与全量备份恢复</p>
 </div>

 <section className="rounded-[24px] border border-[#e8e6e2] bg-white p-5">
 <h3 className="text-base font-semibold text-[#1a1a1a]">AI 配置</h3>
 ...
 className="mt-3 rounded-full border border-[#dfddd8] px-4 py-2 text-sm text-[#555555] transition hover:bg-[#f4f2ee]"
 >
 {showAdvancedAiConfig ? '收起高级 AI 配置' : '展开高级 AI 配置'}
 </button>
 {showAdvancedAiConfig ? (
 <div className="mt-4 space-y-3 border-t border-[#efede8] pt-4">
 <div>
 <Label className="text-[#666666]">AI 提供商</Label>
 <select
 ...
 className="mt-1 w-full rounded-xl border border-[#e8e6e2] bg-[#fbfaf8] px-3 py-2 text-sm"
 >
 ...
 <div>
 <Label className="text-[#666666]">API Key</Label>
 <Input
 type="password"
 ...
 className="mt-1 rounded-xl border-[#e8e6e2] bg-[#fbfaf8]"
 />
 </div>
 <div>
 <Label className="text-[#666666]">API URL</Label>
 <Input
 ...
 <div>
 <Label className="text-[#666666]">模型名</Label>
 <Input
 ...
 <section className="rounded-[24px] border border-[#e8e6e2] bg-white p-5">
 <h3 className="text-base font-semibold text-[#1a1a1a]">面试问题库（P2）</h3>
 <p className="mt-1 text-xs text-[#666666]">从复盘中自动沉淀问题，支持一键清空。</p>
 <div className="mt-3 flex items-center justify-between">
 <span className="text-sm text-[#666666]">已收录 {appSettings.interviewQuestionBank.length} 条</span>
 ...
 <section className="rounded-[24px] border border-[#e8e6e2] bg-white p-5">
 <h3 className="text-base font-semibold text-[#1a1a1a]">数据管理</h3>
 <p className="mt-1 text-xs text-[#666666]">全量导出/导入 JSON（P0），包含 schemaVersion 与迁移兼容。</p>
 ...
 {statusText ? <p className="mt-3 text-sm text-[#666666]">{statusText}</p> : null}
 </section>
